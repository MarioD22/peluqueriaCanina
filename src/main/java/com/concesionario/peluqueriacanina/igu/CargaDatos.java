...
public class CargaDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGuardar.setIcon(new javax.swing.ImageIcon("C:\\Users\\Pc\\Documents\\NetBeansProjects\\PeluqueriaCanina\\guardar.png")); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        //getSelectedItem cuando lo pongo aparece una sugerencia de 
        //transformalo en String darle click
        String alergia = (String) cmbAlergico.getSelectedItem();
        String atEspecial = (String) cmbAtEsp.getSelectedItem();
        
        control.guardar(celDuenio,color,nombreDuenio,nombreMascota,observaciones,raza,alergia,atEspecial);
